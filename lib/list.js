...
exports.ListSet = exports.CommonList = void 0;
        ...
        if (data) {
            ...
            for (let dd of this.dds) {
                dds.push({
                    ns: dd.ns,
                    nn: dd.nn,
                    dataPkField: !dd.as ? dd.pkfield : (0, fields_1.attachAs)(dd.as, dd.pkfield),
                });
            }
            for (let key in data) {
                let drefs = data[key];
...
exports.CommonList = CommonList;
class ListSet {
    constructor() {
        this.listMap = {};
        this.ln = (body) => this.onTrigger(body);
    }
    setFactory(listFactory) {
        this.factory = listFactory;
        return this;
    }
    setTrigger(...names) {
        for (let n of names) {
            trigger_1.Trigger.set(n, this.ln);
        }
        return this;
    }
    setDelListCacheHandler(handler) {
